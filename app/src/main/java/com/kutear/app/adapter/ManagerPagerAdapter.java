 ...
 * 独立页面适配器
 */
public class ManagerPagerAdapter extends BaseAdapter {
    private List<Pager> lists;
    private Context mContent;

    public ManagerPagerAdapter(List<Pager> lists, Context context) {
        this.lists = lists;
    ...
    public static class ViewHolder {
        ...
        public void bindData(Pager pager) {
